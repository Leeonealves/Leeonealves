...
Full Stack Developer with 10+ years of experience in the metal-mechanical industry, now building scalable web applications using React and Node.js.

## 🧠 What I do
  
I build full-stack web applications using React and Node.js, focusing on performance, usability, and real-world business needs.
...
Full-stack web application developed for a professional photographer to manage and showcase their work online.

- 🔧 Tech: React, TypeScript, Node.js, MongoDB, Cloudinary
- 🎯 Features:
  - Secure authentication and admin dashboard (backoffice)
...
![Adobe Premiere](https://img.shields.io/badge/Premiere-9999FF?style=for-the-badge&logo=adobepremierepro)
